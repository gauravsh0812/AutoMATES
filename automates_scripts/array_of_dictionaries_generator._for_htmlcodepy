import os, random, json, shutil, subprocess
...
#ArrayFile = open('/home/gauravs/Automates/automates_scripts/mathml_data_dev.js', 'w')
#ArrayFile2 = open('/home/gauravs/Automates/automates_scripts/latex_data_dev.js', 'w')
#json.dump(MML_eqn_src, ArrayFile)  
#json.dump(PNG_eqn_src, ArrayFile2)
